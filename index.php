...
.bgimg {
  ...
  background-image: url("images/minasValley/cover/connectedCityCover.jpg");
  min-height: 75%;
}
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          ...
          <li><a href="frontEnd/about.php">Sobre nós</a></li>
          <li><a href="frontEnd/category.php">Categorias</a></li>
        </ul>
        ...
        <?php
            ...
            if(isset($_SESSION["usu_id"])){
              ...
              echo "<li><a href='frontEnd/profile.php'><span class='glyphicon glyphicon-user'></span> Perfil</a></li>";
              echo "<li><a href='backEnd/logout.php'><span class='glyphicon glyphicon-off'></span> Logout</a></li>";
            }else{

              echo "<li><a href='frontEnd/signup.php'><span class='glyphicon glyphicon-user'></span> Cadastre-se</a></li>";
              echo "<li><a href='frontEnd/login.php'><span class='glyphicon glyphicon-log-in'></span> Login</a></li>";
            }
...
<div class="w3-content w3-padding" style="max-width:1564px">
    ...
    <div class="w3-row-padding" id="about">
        ...
        <section class="galeria">
            <img class="foto" src="images/minasValley/carousel/startup01.jpg">
            <img class="foto" src="images/minasValley/carousel/startup02.jpg">
            <img class="foto" src="images/minasValley/carousel/startup03.jpg">
        </section>
  ...
  <div class="w3-row-padding">
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-display-container">
        ...
        <a href='frontEnd/startup.php'><img src="images/startups/nubank/logo.png" alt="House" style="width:100%"></a>
      </div>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-display-container">
        <div class="w3-display-topleft w3-black w3-padding">Pic Pay</div>
        <img src="images/startups/picpay/logo.png" alt="House" style="width:100%">
      </div>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-display-container">
        <div class="w3-display-topleft w3-black w3-padding">Vindi</div>
        <img src="images/startups/vindi/logo.png" alt="House" style="width:100%">
      </div>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-display-container">
        <div class="w3-display-topleft w3-black w3-padding">Rubrik</div>
        <img src="images/startups/rubrik/logo.png" alt="House" style="width:100%">
      </div>
    </div>
  </div>
  ...
  <div class="w3-row-padding">
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-display-container">
        ...
        <img src="images/startups/slack/logo.png" alt="House" style="width:99%">
      </div>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-display-container">
        <div class="w3-display-topleft w3-black w3-padding">Loggi</div>
        <img src="images/startups/loggi/logo.png" alt="House" style="width:99%">
      </div>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-display-container">
        <div class="w3-display-topleft w3-black w3-padding">Wework</div>
        <img src="images/startups/wework/logo.jpg" alt="House" style="width:99%">
      </div>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-display-container">
        <div class="w3-display-topleft w3-black w3-padding">NIO</div>
        <img src="images/startups/nio/logo.png" alt="House" style="width:99%">
      </div>
    </div>
  </div>
  ...
  <div class="w3-row-padding">
    <div class="w3-col l3 m6 w3-margin-bottom">
      <img src="images/projects/pagamentoQRCode/logo.jpg" style="width:100%">
      ...
      <p><a href='frontEnd/project.php' class="w3-button w3-light-grey w3-block">Saiba mais</a></p>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <img src="images/projects/cachorroRobo/logo.jpg" style="width:100%">
      <h3>Cachorro Robo</h3>
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <img src="images/projects/aloQuemFala/logo.png" style="width:100%">
      <h3>Alô, quem fala?</h3>
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <img src="images/projects/casaAutomatica/logo.jpg" style="width:100%">
  ...
  <div class="w3-row-padding">
    <div class="w3-col l3 m6 w3-margin-bottom">
      <img src="images/investors/binance/logo.png" style="width:100%">
      <h3>Binance</h3>
      ...
      <p><a href='frontEnd/investor.php' class="w3-button w3-light-grey w3-block">Saiba mais</a></p>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <img src="images/investors/generalAtlantic/logo.png" style="width:100%">
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <img src="images/investors/lactec/logo.png" style="width:100%">
      <h3>Lactec</h3>
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <img src="images/investors/sequoia/logo.png" style="width:100%">
      <h3>Sequoia</h3>
                ...
                <div class="w3-text-grey w3-padding-16">
                    ...
                    <div style="text-align: center">
                        <br><h3 class="w3-border-black w3-padding-16" style="color: #000000;">Minas Valley é a maior comunidade de startups do Brasil
                            <a <div <a href="frontEnd/signup.php">
